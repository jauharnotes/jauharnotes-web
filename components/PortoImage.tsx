...
function PortoImage({ img, link }: Props) {
  return (
    <>
      <div className="h-[261px] w-[362px] overflow-hidden rounded-2xl border-2 border-slate-300 bg-white transition-all duration-500 ease-in-out z-0 md:hover:z-50 md:hover:scale-125">
