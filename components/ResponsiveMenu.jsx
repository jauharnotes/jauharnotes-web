    ...
    <>
        ...
        <div className="flex-col items-center justify-center nav__menu color">
          <ul className="flex-col items-center space-y-12 py-5 text-center">
            <li>
              <Link href="/">
                <a
                  className={`decoration text-3xl font-bold text-slate-300 transition-all delay-100 duration-300 hover:text-white ${
                    router.pathname == '/' &&
      ...
      >
        <div className="flex w-full items-center justify-between">
          {/* <p>Johar</p> */}
            <Link href='/'>
              <a className={`ml-10 font-inter text-[23px] font-bold  ${toggle ? 'text-slate-300 hover:text-white' : 'text-base hover:text-[#12413e'}]`}>Jauhar.</a>
          </Link>
          <button
          ...
          >
            <span
              className={`block h-1 w-7 rounded-md transition-all delay-150 ease-out ${
                toggle ? 'translate-y-[8px] rotate-[45deg] bg-slate-300' : 'bg-base'
              }`}
            ></span>
            <span
              className={`block h-1 w-7 rounded-md transition-all delay-150 ease-out ${
            ...
            <span
              className={`block h-1 w-7 rounded-md transition-all delay-150 ease-out ${
                toggle
                  ? 'translate-y-[-8px] rotate-[-45deg] bg-slate-300'
                  : 'bg-base'
              }`}
            ></span>
          </button>
