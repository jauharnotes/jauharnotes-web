...
function Welcome() {
  return (
    <Layout>
        <div className='flex flex-wrap justify-center items-center gap-10 mt-7 md:mt-[115px]'>
            <div className='flex items-center justify-between md:ml-14 bg-base'>
            ...
            <div className='w-[500px] h-[500px] bg-light-blue space-y-7 text-center md:text-left'>
